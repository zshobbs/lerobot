...
@RobotConfig.register_subclass("lekiwi_uni")
@dataclass
class LeKiwiUniConfig(RobotConfig):
    port: str = "/dev/ttyUSB-follower-left"  # port to connect to the bus
...
@RobotConfig.register_subclass("lekiwi_uni_client")
@dataclass
class LeKiwiUniClientConfig(RobotConfig):
    # Network Configuration
    remote_ip: str
    port_zmq_cmd: int = 5555
    port_zmq_observations: int = 5556
