...
from .config_lekiwi import LeKiwiHostConfig # Changed import
from .config_lekiwi_uni import LeKiwiUniConfig # Changed import
from .lekiwi_uni import LeKiwiUni # Changed import
...
def main():
    logging.info("Configuring LeKiwi Uni-arm Robot") # Changed log message
    robot_config = LeKiwiUniConfig() # Changed config class
    robot_config.id = "AlohaMiniUniRobot" # Changed robot ID
    robot = LeKiwiUni(robot_config) # Changed robot class
