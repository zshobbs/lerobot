...
class LeKiwiUni(Robot): # Renamed class
    ...
    def __init__(self, config: LeKiwiUniConfig): # Changed config type hint
        ...
        self.left_bus = FeetechMotorsBus(
            ...
            motors={
                ...
                "base_right_wheel": Motor(10, "sts3215", norm_mode_body),
    ...
    def calibrate(self) -> None:
        """
        Uni-arm calibration (left arm + chassis on self.left_bus):
        ...
        if self.calibration:
            ...
            if user_input.strip().lower() != "c":
                logger.info("Writing existing calibration to left bus (trim per-bus caches)")
