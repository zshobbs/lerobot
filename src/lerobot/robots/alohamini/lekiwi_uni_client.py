...
from .config_lekiwi_uni import LeKiwiUniClientConfig
...
class LeKiwiUniClient(Robot):
    config_class = LeKiwiUniClientConfig
    name = "lekiwi_uni_client"

    def __init__(self, config: LeKiwiUniClientConfig):
        import zmq
